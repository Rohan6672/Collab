...
Original file is located at
    https://colab.research.google.com/drive/1nj3rrSeSHoayLfCF0itDr3i3vCMx4wGt
"""
...
the_image=PIL.Image.open('/content/photo-students-2021.webp').convert('RGB').resize((800,400))
scores,boxes=detect(the_image,model,transform)
